    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            else if (answer4 == 3)
            {
                ...
                ShowGo("Капча-Монстра хрипит консольными командами, догружается, наконец, до конца и выдает: сколько будет (2 + 2) * 2?");
        ...
        static void ShowGo(string text)
        {
            Console.ForegroundColor = ConsoleColor.DarkGreen;
